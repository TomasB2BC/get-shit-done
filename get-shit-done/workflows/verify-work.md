...
```bash
DECISION=$(node C:\Users\tomas\.claude/get-shit-done/bin/gsd-tools.js auto-decide --type binary --question "Max revision iterations reached. Force proceed or abandon?" --options '["Force proceed","Abandon"]' --raw)
